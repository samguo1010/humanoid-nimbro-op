...
class WINDECLSPEC GroupBulkRead
{
 ...
 public:
  std::vector<uint8_t> GetListId() { return id_list_; }
  uint16_t GetAddress(uint8_t id) { return address_list_[id]; }
  uint16_t GetDataLength(uint8_t id){ return length_list_[id]; }
  ////////////////////////////////////////////////////////////////////////////////
  ...
  std::vector<uint8_t> getDatas(uint8_t id, uint16_t address, uint16_t data_length);
