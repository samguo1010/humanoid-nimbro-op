...
// Includes
#include <opencr/read_thread.h>
#include <opencr/dynamixel.h>
#include <opencr/dynamixel_sdk.h>
...
namespace opencr
{
	...
	protected:
		...
		bool parseBRPacket(uint8_t id, std::vector<BRData>* servoData, BRBoard* cm730Data);
		bool parseCM730Data(uint8_t* data, BRBoard* cm730Data);
