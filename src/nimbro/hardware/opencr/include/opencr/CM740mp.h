...
//
class CM740mp : public opencr::CM730
{
public:
	CM740mp(const std::string& resourcePath, const std::string& configParamPath) : CM730(resourcePath, configParamPath, boost::make_shared<opencr::DynamixelMX>()), m_inMegapacketMode(false), m_isMegapacketConfigured(false), m_writeMegapacket(false) {}
