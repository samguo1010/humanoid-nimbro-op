...
#include "opencr/group_bulk_read.h"
...
std::vector<uint8_t> GroupBulkRead::getDatas(uint8_t id, uint16_t address, uint16_t data_length)
{
  ...
  {
    data.push_back(data_list_[id][address - start_addr + i]);
  }
